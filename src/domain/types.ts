 ...
 *
 * Every one of these is a HEAD prop, and that is not an accident. A
 * superhero set was tried and removed: this mouse is a side-on blob with
 * no shoulders, no chest, no neck and no face-front, and superhero
 * identity lives in exactly those places. Capes, masks and chest emblems
 * had nothing to attach to. Hats read instantly at 34px. Anything added
 * here should be something you wear on your head.
 */
